...
def run_protocol(directory_path, combined_df, sort_column, source_column, 
   ...
   # Ask the user for the new file name
    ...
    with open(new_script_name, 'w') as script_file:
        ...
        script_file.write("from opentrons import protocol_api\n")
        script_file.write("\n")
        script_file.write("# set up opentrons\n")
        script_file.write("requirements = {\"robotType\": \"OT-2\", \"apiLevel\": \"2.15\"}\n")
        script_file.write("\n")
        ...
        script_file.write("\n") 
        script_file.write("def run(protocol: protocol_api.ProtocolContext):\n")
